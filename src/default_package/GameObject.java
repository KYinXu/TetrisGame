	...
	public void moveLeft() {
		...
		if (xPos[0] >= 1) {
			...
			if (currentState.equalsIgnoreCase("j") || currentState.equalsIgnoreCase("l")) {
				...
				if (currentState.equalsIgnoreCase("j") || currentState.equalsIgnoreCase("l")) {
					if (canMoveLeft == true && grid.grid[xPos[0] - 1][yPos[0]] == false && grid.grid[xPos[3] - 1][yPos[3]] == false) {
						for (int i = 0; i < 4; i++) {
							if (xPos[i] <= 0) {
								return;
							}
				...
				if (currentState.equalsIgnoreCase("j") || currentState.equalsIgnoreCase("l")) {
					if (canMoveLeft == true
							&& grid.grid[xPos[3] - 1][yPos[3]] == false && grid.grid[xPos[2] - 1][yPos[2]] == false && grid.grid[xPos[1]-1][yPos[1]] == false) {
						for (int i = 0; i < 4; i++) {
							if (xPos[i] <= 0) {
								return;
							}
				...
				if (currentState.equalsIgnoreCase("j")) {
					if (canMoveLeft == true && grid.grid[xPos[1] - 1][yPos[1]] == false && grid.grid[xPos[0] - 1][yPos[0]] == false) {
						for (int i = 0; i < 4; i++) {
							if (xPos[i] <= 0) {
								return;
							}
				...
				if(currentState.equalsIgnoreCase("l")) {
					if (canMoveLeft == true && grid.grid[xPos[3] - 1][yPos[3]] == false && grid.grid[xPos[1] - 1][yPos[1]] == false) {
						for (int i = 0; i < 4; i++) {
							if (xPos[i] <= 0) {
								return;
							}
	...
	public void moveRight() {
		...
		if (xPos[3] <= 8) {
			if(rotation == 0) {
				...
				if (currentState.equalsIgnoreCase("line") || currentState.equalsIgnoreCase("square")) {
					if (canMoveRight == true && grid.grid[xPos[3] + 1][yPos[0]] == false
							&& grid.grid[xPos[3] + 1][yPos[1]] == false && grid.grid[xPos[3] + 1][yPos[2]] == false
			...
			if(rotation == 1) {
				if (currentState.equalsIgnoreCase("l")) {
					if (canMoveRight == true && grid.grid[xPos[1] + 1][yPos[1]] == false && grid.grid[xPos[3] + 1][yPos[3]] == false) {
						for (int i = 0; i < 4; i++) {
							if (xPos[i] == grid.width - 1) {
								return;
							}
				...
				if(currentState.equalsIgnoreCase("j"))
					if (canMoveRight == true && grid.grid[xPos[1] + 1][yPos[1]] == false && grid.grid[xPos[0] + 1][yPos[0]] == false) {
						for (int i = 0; i < 4; i++) {
							if (xPos[i] == grid.width - 1) {
								return;
							}
	...
	void update(String direction) {
		...
		if (direction.equalsIgnoreCase("check")) {
			...
			for (int i = 0; i < 4; i++) {
				...
				if (xPos[rightwallcheck] <= 8 && xPos[leftwallcheck] >= 1) {
						if (currentState.equalsIgnoreCase("t")) {
						...
						if (currentState.equalsIgnoreCase("j") || currentState.equalsIgnoreCase("l")) {
							...
							if (xPos[3] <= 8 && xPos[0] >= 2) {
								if(xPos[3] + 1 > grid.grid.length || yPos[3] < 0) {
									canMoveRight = false;
									break;
								}
							else if (canMoveRight == true && grid.grid[xPos[3] + 1][yPos[3]]
										&& grid.grid[xPos[2] + 1][yPos[2]] && grid.grid[xPos[1] + 1][yPos[1]]) {
									canMoveRight = false;
								} else {
									canMoveRight = true;
								}
		...
		if (direction.equalsIgnoreCase("space")) {
			if (canMoveDown == true) {
					for (int i = 0; i < grid.height; i++) {
						if (currentState.equalsIgnoreCase("t") && yPos[0] + 1 < grid.height && yPos[1] + 1 < grid.height && yPos[2] + 1 < grid.height && yPos[3] + 1 < grid.height) {
						...
						if (currentState.equalsIgnoreCase("line") && yPos[0] + 1 < grid.height && yPos[1] + 1 < grid.height && yPos[2] + 1 < grid.height && yPos[3] + 1 < grid.height) {
							if (grid.grid[xPos[0]][yPos[0] + 1] == false || grid.grid[xPos[1]][yPos[1] + 1] == false
						...
						if (currentState.equalsIgnoreCase("square") && yPos[0] + 1 < grid.height && yPos[1] + 1 < grid.height && yPos[2] + 1 < grid.height && yPos[3] + 1 < grid.height) {
						...
						if (currentState.equalsIgnoreCase("s") && yPos[0] + 1 < grid.height && yPos[1] + 1 < grid.height && yPos[2] + 1 < grid.height && yPos[3] + 1 < grid.height) {
						...
						if (currentState.equalsIgnoreCase("z") && yPos[0] + 1 < grid.height && yPos[1] + 1 < grid.height && yPos[2] + 1 < grid.height && yPos[3] + 1 < grid.height) {
						...
						if (currentState.equalsIgnoreCase("j") || currentState.equalsIgnoreCase("l")) {
							if(yPos[0] + 1 < grid.height && yPos[1] + 1 < grid.height && yPos[2] + 1 < grid.height && yPos[3] + 1 < grid.height) {
